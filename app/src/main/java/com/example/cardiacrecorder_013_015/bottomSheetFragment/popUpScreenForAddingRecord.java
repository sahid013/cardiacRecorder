...
public class popUpScreenForAddingRecord extends BottomSheetDialogFragment {
    //BindView for the fragment id access
    Unbinder unbinder;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //date picker is a user interface control that is used for picking date, month and year
        ...
        //picking time from timePickerDialog
    ...
    /**
     * This function validate input field and show messages if a field is empty v
     * @return null
     */
    public boolean validateFields() {
        if(date.getText().toString().equalsIgnoreCase("")) {
            ...
            Toast.makeText(activity, "Systolic pressure cannot be empty", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(diastolic_pressure.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Diastolic pressure cannot be empty", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                //setting up date, time, systolic pressure and other information
            ...
            //Page will auto refresh and a toast message will show up
            @Override
